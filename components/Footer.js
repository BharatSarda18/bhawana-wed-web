    ...
    <footer className="py-8 bg-wedding-maroon text-white text-center">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-4 flex justify-center items-center">
          <a target='blank' href="https://www.instagram.com/lalit_bha_gaya?igsh=MWV1NzhqY2Z4ZzA5dQ==" className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:bg-wedding-gold transition duration-300">
